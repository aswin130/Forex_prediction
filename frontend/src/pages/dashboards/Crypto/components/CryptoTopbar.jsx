		...
		<div className="d-flex justify-content-between mb-3">
			<div className="align-self-center">
				...
				>
					...
					<ModalBody>
						<div className="mb-2">
							<label htmlFor="cryptocurrency">From Currency</label>
							<select
								className="form-select"
								aria-label="Default select example"
							>
								<option selected>-- Currency --</option>
								<option value="BTC">GBP</option>
								<option value="ETH">EUR</option>
							</select>
						</div>
						<div className="mb-2">
							<label htmlFor="cryptocurrency">To Currency</label>
							<select
								className="form-select"
								aria-label="Default select example"
							>
			...
			<div className="media">
				...
				<div className="media-body align-self-center">
					...
					<h5 className="mt-0 text-dark mb-1">122.00125503 USD</h5>
				</div>
			</div>
		</div>
	)
