		...
		<Card>
			<CardBody>
				<div className="crypto-report-history d-flex justify-content-end">
					<Nav defaultActiveKey="2" className="nav nav-tabs mb-3">
						<NavItem>
							<NavLink eventKey="1">Hour</NavLink>
						</NavItem>
						<NavItem>
							<NavLink eventKey="2">Day</NavLink>
						</NavItem>
						<NavItem>
							<NavLink eventKey="3">Week</NavLink>
						</NavItem>
						<NavItem>
							<NavLink eventKey="4">Month</NavLink>
						</NavItem>
						<NavItem>
							<NavLink eventKey="5">Order Book</NavLink>
						</NavItem>
					</Nav>
				</div>
				<Row>
						...
						<div className="media">
							...
							<div className="media-body align-self-center">
								<div className="coin-bal">
									<h4 className="m-0">$50,289.45</h4>
									<p className="text-muted mb-0">
										USDVSEUR&nbsp;
										<span className="text-muted font-12">(USDVSEUR)</span>&nbsp;
										<span className="text-success">
											2.5% <i className="mdi mdi-arrow-up" />
										</span>
									</p>
								</div>
							</div>
